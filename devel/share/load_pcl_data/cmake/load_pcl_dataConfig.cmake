...
if(load_pcl_data_CONFIG_INCLUDED)
  return()
endif()
set(load_pcl_data_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(load_pcl_data_SOURCE_PREFIX /home/henxu/ROSProjects/ROS_P1/src/load_pcl_data)
  set(load_pcl_data_DEVEL_PREFIX /home/henxu/ROSProjects/ROS_P1/devel)
  set(load_pcl_data_INSTALL_PREFIX "")
  set(load_pcl_data_PREFIX ${load_pcl_data_DEVEL_PREFIX})
else()
  set(load_pcl_data_SOURCE_PREFIX "")
  set(load_pcl_data_DEVEL_PREFIX "")
  set(load_pcl_data_INSTALL_PREFIX /home/henxu/ROSProjects/ROS_P1/install)
  set(load_pcl_data_PREFIX ${load_pcl_data_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'load_pcl_data' is deprecated")
...
set(load_pcl_data_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/henxu/ROSProjects/ROS_P1/src/load_pcl_data/include;/usr/include/eigen3;/usr/include/pcl-1.10;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2 " STREQUAL " ")
  set(load_pcl_data_INCLUDE_DIRS "")
  set(_include_dirs "/home/henxu/ROSProjects/ROS_P1/src/load_pcl_data/include;/usr/include/eigen3;/usr/include/pcl-1.10;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${load_pcl_data_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'load_pcl_data' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'load_pcl_data' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/henxu/ROSProjects/ROS_P1/src/load_pcl_data/${idir}'.  ${_report}")
    endif()
    _list_append_unique(load_pcl_data_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND load_pcl_data_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND load_pcl_data_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT load_pcl_data_NUM_DUMMY_TARGETS)
      set(load_pcl_data_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::load_pcl_data::wrapped-linker-option${load_pcl_data_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR load_pcl_data_NUM_DUMMY_TARGETS "${load_pcl_data_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::load_pcl_data::wrapped-linker-option${load_pcl_data_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND load_pcl_data_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/henxu/ROSProjects/ROS_P1/devel/lib;/home/henxu/ROSProjects/catkin_ws/devel/lib;/home/henxu/one_liom/one_liom1/devel/lib;/opt/ros/noetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(load_pcl_data_LIBRARY_DIRS ${lib_path})
      list(APPEND load_pcl_data_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'load_pcl_data'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND load_pcl_data_LIBRARIES ${lib})
    endif()
  endif()
...
set(load_pcl_data_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${load_pcl_data_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 load_pcl_data_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${load_pcl_data_dep}_FOUND)
      find_package(${load_pcl_data_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${load_pcl_data_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(load_pcl_data_INCLUDE_DIRS ${${load_pcl_data_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(load_pcl_data_LIBRARIES ${load_pcl_data_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${load_pcl_data_dep}_LIBRARIES})
  _list_append_deduplicate(load_pcl_data_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(load_pcl_data_LIBRARIES ${load_pcl_data_LIBRARIES})

  _list_append_unique(load_pcl_data_LIBRARY_DIRS ${${load_pcl_data_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(load_pcl_data_EXPORTED_TARGETS ${${load_pcl_data_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${load_pcl_data_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
